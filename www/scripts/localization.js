class Localization {
    ...
    static logHelpCall() {
        console.log("Help translating FastShare: https://hosted.weblate.org/engage/fastshare/");
    }
    ...
    static logHelpCallKey(key, attr) {
        ...
        console.warn(`Translate this string here: https://hosted.weblate.org/browse/fastshare/fastshare-spa/${locale}/?q=${keyComplete}`);
    }
